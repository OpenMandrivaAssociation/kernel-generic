...
%define src_uname_r	3.3.3-1
%define source_release	1
%define build_release	1%{nil}
%define archive		kernel-generic-3.3.3-1.1
...
%define uname_r		3.3.3-1.1-generic
...
%changelog
* Mon Apr 23 2012 Franck Bui <franck.bui@mandriva.com> 3.3.3-1.1-generic
  + Mandriva Release v3.3.3-1
