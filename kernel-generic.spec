#
# Spec file generated by kdist version v0.0-5-g4ac4
#
%define name		kernel-generic
%define version		3.1.6

%define src_uname_r	3.1.6-1
%define uname_r		3.1.6-1.1-generic%{nil}

%define source_release	1
%define build_release	1%{nil}

%define archive		kernel-generic-3.1.6-1.1
...
Source1:		3.1.6-1.1-generic-x86_32-defconfig
Source2:		3.1.6-1.1-generic-x86-develfiles.list
Source3:		3.1.6-1.1-generic-develfiles.list
...
%changelog
* Fri Dec 23 2011 Franck Bui <franck.bui@mandriva.com> 3.1.6-1.1-generic
  + Mandriva Release v3.1.6-1
