...
%define uname_r		3.2.5-1.1-generic%{nil}

%define source_release	1
%define build_release	1%{nil}

%define archive		kernel-generic-3.2.5-1.1
...
Source1:		3.2.5-1.1-generic-x86_32-defconfig
Source2:		3.2.5-1.1-generic-x86-develfiles.list
Source3:		3.2.5-1.1-generic-develfiles.list
Source4:		3.2.5-1.1-generic-output-develfiles.list
...
%changelog
* Wed Feb 08 2012 Franck Bui <franck.bui@mandriva.com> 3.2.5-1.1-generic
