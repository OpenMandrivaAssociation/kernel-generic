...
%define uname_r		3.1.6-1.2-generic%{nil}

%define source_release	1
%define build_release	2%{nil}

%define archive		kernel-generic-3.1.6-1.2
...
Source1:		3.1.6-1.2-generic-x86_32-defconfig
Source2:		3.1.6-1.2-generic-x86-develfiles.list
Source3:		3.1.6-1.2-generic-develfiles.list
Source4:		3.1.6-1.2-generic-output-develfiles.list
...
%changelog
* Wed Dec 28 2011 Franck Bui <franck.bui@mandriva.com> 3.1.6-1.2-generic
