#
# Spec file generated by kdist version v0.2-9-g3445
#
%define name		kernel-generic
%define version		3.2.6
%define src_uname_r	3.2.6-1
%define uname_r		3.2.6-1.1-generic%{nil}
%define source_release	1
%define build_release	1%{nil}
%define archive		kernel-generic-3.2.6-1.1
...
Source1:		3.2.6-1.1-generic-x86_32-defconfig
Source2:		3.2.6-1.1-generic-x86-develfiles.list
Source3:		3.2.6-1.1-generic-develfiles.list
Source4:		3.2.6-1.1-generic-output-develfiles.list
...
%changelog
* Tue Feb 14 2012 Franck Bui <franck.bui@mandriva.com> 3.2.6-1.1-generic
  + Mandriva Release v3.2.6-1
